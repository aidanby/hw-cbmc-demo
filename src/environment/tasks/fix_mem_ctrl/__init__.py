"""fix-mem-ctrl: complex circuit with interacting wiring bugs."""
...
@final
class FixMemCtrlTask(DebugCircuitTask):
    id = "fix-mem-ctrl"
    sv_filename = "FixMemCtrl.sv"
    config_filename = "fix-mem-ctrl.json"
    bound = 10
    tier = "5"
